...
const get_flash_light = require("../../models/get_flash_light.js");
...
const ProductDetail = require("../../models/get_product_data.js");
...
router.post("/rack_data", verifyToken, createRack);
router.put("/rack_data/:id", verifyToken, updateRack);
router.delete("/rack_data/:id", verifyToken, deleteRack);
...
// Product detail
router.post("/product_detail", verifyToken, ProductDetail);
